//
// Generated on 2020/03/29 by inimoni 
//
...
/**
    TICS.ini input output class.
*/
class TICSIni
{
public:

    TICSIni(string_t fname = _T(""))
    {
        initFileName = _T("./TICS.ini"); //Default file.    
        init();
        load(fname);
    }
...
protected:
    ...
    bool iniRW(string_t f, int r)
    {
        ...
        s = _T("FLASH");
        inimoni::inirw(r, f, s, _T("time1            "), FLASH.time1);
        inimoni::inirw(r, f, s, _T("time2            "), FLASH.time2);
        inimoni::inirw(r, f, s, _T("maxIdx           "), FLASH.maxIdx);
        return true;
    }
...
typedef TICSIni TICSFile; //êVãåå›ä∑
